    ...
    <div class="col-sm-6 col-12">
        <div class="box-form">
                    ...
                    <div class="info-row">
                        ...
                        <div class="value">
                            <div class="input-more-button">
                                ...
                                <input type="text" class="form-control highlight bold" @keyup.enter="onEnterMaGD" :value="input_magd" @change="e=>input_magd=e.target.value"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="value">
                            <div class="select-custom" ref="ds_loaihinh">
                                <select2 :settings="{ dropdownParent: $refs['ds_loaihinh'] }" ref="cboLoaiHinh"
                                    ...
                                    :options="ds_loaihinh_theo_dv.map(e=> ({id: e.LOAITB_ID, text: e.LOAIHINH_TB}))"
                                    :disabled="disableLoaiHinhTB"
                                    @change="changeLoaiHinhTBCu"
                                    >
                                </select2>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-8 col-12">
                    <div class="info-row">
                        ...
                        <div class="value">
                            <div class="select-custom" ref="ds_muccuoc_tb">
                                <select2 :settings="{ dropdownParent: $refs['ds_muccuoc_tb'] }" ref="cboMucCuocTB"
                                    v-model="muoccuoc_tb_selected" class="select2"
                                    :options="ds_muccuoc_tb.map(e=> ({id: e.muccuoctb_id, text: e.tenmuccuoc}))"
                                    :disabled="disableMucCuocTB"
                                    @change="changeMucCuocTB">
                                </select2>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="info-row">
                        ...
                        <div class="value">
                            <div class="input-more-button">
                                ...
                                <div class="select-custom" ref="ds_khuyenmai">
                                    <select2 :settings="{ dropdownParent: $refs['ds_khuyenmai'] }" ref="cboKhuyenMai"
                                        v-model="khuyenmai.khuyenmai_selected" class="select2"
                                        :options="khuyenmai.ds_khuyenmai.map(e=> ({id: e.khuyenmai_id, text: e.ten_km}))"
                                        :disabled="!khuyenmai.checkKhuyenMai||khuyenmai.disableCheckKhuyenMai">
                                    </select2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="value">
                            <div class="input-more-button">
                                ...
                                <div class="select-custom" ref="ds_tratruoc">
                                    <select2 :settings="{ dropdownParent: $refs['ds_tratruoc'] }" ref="cboTraTruoc"
                                        v-model="tratruoc.tratruoc_selected" class="select2"
                                        :options="tratruoc.ds_tratruoc.map(e=> ({id: e.khuyenmai_id, text: e.ten_km}))"
                                        :disabled="!tratruoc.checkTraTruoc||tratruoc.disableCheckTraTruoc">
                                    </select2>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-4 col-12">
                    <!-- Dịch vụ kênh thê riêng -->
                    <div class="info-row" v-if="dichvu_selected==9">
                        <div class="key w90">Thông số TC</div>
                        <div class="value">
                            <div class="info-row">
                                <button class="btn btn-second fullw" @click="clickDiemDauTSL">
                                    Đ.đầu
                                </button>
                            </div>
                            <div class="info-row">
                                <button class="btn btn-second fullw" @click="clickDiemCuoiTSL">
                                    Đ.cuối
                                </button>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-12">
                    <div class="info-row">
                        <div class="key w90">Gói KT</div>
                        <div class="value">
                            <div class="select-custom" ref="ds_goikt">
                                <select2 :settings="{ dropdownParent: $refs['ds_goikt'] }" ref="cboGoiKT"
                                    v-model="goikt_selected" class="select2"
                                    :options="ds_goikt.map(e=> ({id: e.goikt_id, text: e.ten_goi}))"
                                    >
                                </select2>
                            </div>
                        </div>
...
import ChonKhuyenMaiModal from '../ChangeSubsType/popups/ChonKhuyenMaiModal.vue'
import DangKyChiTietKhuyenMaiModal from '../ChangeSubsType/popups/DangKyChiTietKhuyenMaiModal.vue'
export default {
    ...
    computed:{
      ds_loaihinh_theo_dv(){
        if(this.dichvu_selected==DichVuVienThong.DI_DONG){
          //20
          return this.ds_loaihinh.filter(x=>(x.DICHVUVT_ID==DichVuVienThong.DI_DONG)&&(x.LOAITB_ID==20))
        }else if(this.dichvu_selected==DichVuVienThong.ADSL){
          //11,58,61,//57,59
          //11,58,61,57,59
          return this.ds_loaihinh.filter(x=>(x.DICHVUVT_ID==DichVuVienThong.ADSL)&&(x.LOAITB_ID==11||x.LOAITB_ID==58||x.LOAITB_ID==61||x.LOAITB_ID==57||x.LOAITB_ID==59))
        }else{
    ...
    methods:{
        ...
        clickDiemDauTSL(){
          this.$emit('clickDiemDauTSL')
        },
        clickDiemCuoiTSL(){
          this.$emit('clickDiemCuoiTSL')
        },
        clickThongSoTC(){
          this.$emit('clickThongSoTC')
        },
        async changeDichVu(){
          //handle
        ...
        async HienThiTTHopDongTB_B2(item){
          ...
          if(item.hasOwnProperty('GOIKT_ID')&&item.GOIKT_ID!=null){
            this.goikt_selected=item.GOIKT_ID
          }else{
            this.goikt_selected=this.ds_goikt.length>0?this.ds_goikt[0].goikt_id:-1
          }
          this.input_soao=''
