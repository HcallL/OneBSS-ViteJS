                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="tocdo_cir_selected" disabled class="form-control">
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom">
                                    <select v-model="tocdo_pir_selected" disabled class="form-control">
                                        <option v-for="item in ds_tocdo" :key="item.tocdo_id" :value="item.tocdo_id">
                                            {{item.tentrangbi}}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_tk" @change="v=>input_cuoc_tk=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_tc" @change="v=>input_cuoc_tc=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_tkdt" @change="v=>input_cuoc_tkdt=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_ht" @change="v=>input_cuoc_ht=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_tcdt" @change="v=>input_cuoc_tcdt=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <vue-numeric  class="form-control tright" separator="," :value="input_cuoc_tb" @change="v=>input_cuoc_tb=v.target.value" disabled placeholder="0" output-type="Number"></vue-numeric>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            <div class="key w80">Loại cáp</div>
                            <div class="value">
                                <div class="select-custom" ref="ds_loaicap">
                                    <select2 :settings="{ dropdownParent: $refs['ds_loaicap'] }" ref="cboLoaiCap"
                                        v-model="loaicap_moi_selected" class="select2"
                                        :options="ds_loaicap.map(e=> ({id: e.loaicap_id, text: e.loaicap}))"
                                        >
                                    </select2>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            <div class="key">Tốc độ CIR</div>
                            <div class="value">
                                <div class="select-custom" ref="ds_tocdo_cir">
                                    <select2 :settings="{ dropdownParent: $refs['ds_tocdo_cir'] }" ref="cboTocDoCir"
                                        v-model="tocdo_cir_moi_selected" class="select2"
                ...
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="select-custom" ref="ds_tocdo_pir">
                                    <select2 :settings="{ dropdownParent: $refs['ds_tocdo_pir'] }" ref="cboTocDoPir"
                                        v-model="tocdo_pir_moi_selected" class="select2"
                                        :options="ds_tocdo.map(e=> ({id: e.tocdo_id, text: e.toc_do}))"
                                        :disabled="!checkTocDoPIRMoi"
                                        >
                                    </select2>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="info-row">
                            <div class="key w80">Modem</div>
                            <div class="value">
                                <div class="select-custom" ref="ds_modem">
                                    <select2 :settings="{ dropdownParent: $refs['ds_modem'] }" ref="cboModem"
                                        v-model="modem_moi_selected" class="select2"
                                        :options="ds_modem.map(e=> ({id: e.loaimd_id, text: e.loai_md}))">
                                    </select2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="value">
                                <div class="select-custom" ref="ds_doitac">
                                    <select2 :settings="{ dropdownParent: $refs['ds_doitac'] }" ref="cboDoiTac"
                                        v-model="doitac_moi_selcted" class="select2"
...
export default {
    ...
    methods:{
        ...
        async HienThiTTMoRong_DB(item){
            ...
            this.input_site_id=item.site_id?item.site_id.toString():''
            this.input_site_id_moi=item.site_id?item.site_id.toString():''
            ...
            this.input_cuoc_tk=item.cuoc_tk?item.cuoc_tk.toString():''
            this.input_cuoc_tk_moi=item.cuoc_tk?item.cuoc_tk.toString():''
            this.input_cuoc_tc=item.cuoc_tc?item.cuoc_tc.toString():''
            this.input_cuoc_tc_moi=item.cuoc_tc?item.cuoc_tc.toString():''
            this.input_cuoc_ht=item.cuoc_ht?item.cuoc_ht.toString():''
            this.input_cuoc_ht_moi=item.cuoc_ht?item.cuoc_ht.toString():''
            this.input_cuoc_tb=item.cuoc_tbi?item.cuoc_tbi.toString():''
            this.input_cuoc_tb_moi=item.cuoc_tbi?item.cuoc_tbi.toString():''
            //
        ...
        async HienThiTTMoRong_HD(item){
            ...
            if(item.doitac_id!=null){
                ...
                this.input_cuoc_tkdt_moi=item.cuoc_tkdt?item.cuoc_tkdt.toString():''
                this.input_cuoc_tcdt_moi=item.cuoc_tcdt?item.cuoc_tcdt.toString():''
