    ...
    <div class="box-col box-form">
        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-12">
                <div class="info-row">
                    <div style="padding-top: 4px!important; padding-right: 2px; width: 130px;">Thông số thi công</div>
                    <div class="value">
                        <b-button variant="outline-primary" class="mr-3" @click="btnDiemDau_Click">Điểm đầu</b-button>
                        <b-button variant="outline-primary" class="mr-3" @click="btnDiemCuoi_Click">Điểm cuối</b-button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        btnDiemDau_Click() {
            this.$emit('btnDiemDau_Click');
        },
        btnDiemCuoi_Click() {
            this.$emit('btnDiemCuoi_Click');
        },
    },
    mounted() {
    ...
    watch: {
        "model.v3_so_may_acc": async function(val){      
            this.$emit('txtMaTB_TextChanged');
        }
    }
}
</script>