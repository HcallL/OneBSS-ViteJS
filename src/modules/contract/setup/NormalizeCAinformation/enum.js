...
const listDichVuCoCap = [{
	CO_DINH: DichVuVienThong.CO_DINH,
	ADSL: DichVuVienThong.ADSL,
	MEGAWAN: DichVuVienThong.MEGAWAN,
	TSL: DichVuVienThong.TSL,
	IMS: DichVuVienThong.IMS
}]


const listDichVuCNTT = [{
	DICHVU_CNTT: DichVuVienThong.DICHVU_CNTT,
	TRUNGTAM_DULIEU: DichVuVienThong.TRUNGTAM_DULIEU,
	ANTOAN_BAOMAT_TT: DichVuVienThong.ANTOAN_BAOMAT_TT,
	HOINGHI_TRUYENHINH: DichVuVienThong.HOINGHI_TRUYENHINH
}]
