...
export const ChiTietDV_IMS = {
    didong:1,
    internet:2,
    duongrieng:3,
}

export const GOICUOC_DD = {
    POSTPAID: 9,
    MB1: 6,
    MB2: 7,
    MB0: 13,
...
export const CAConstanst = {
  CAProfileListEndpoint:"http://10.70.52.120:4740/api/ca_profile_list",
  CAProvinceEndpoint:"http://10.70.52.120:4740/api/province",
  CACreateCustomerEndpoint:"http://10.70.52.120:4740/api/create_customer",
  CAGroupListEndpoint:"http://10.70.52.120:4740/api/group_list",
  CAFindCustomerEndpoint:"http://10.70.52.120:4740/api/find_customer",
  CARCListEndpoint:"http://10.70.52.120:4740/api/rc_list",
  CARequestApproveEndpoint:"http://10.70.52.120:4740/api/req_approve",
  CAGenTokenEndPoint:"http://10.70.52.120:4740/api/gen_token",
  CARejectRequestEndpoint:"http://10.70.52.120:4740/api/req_reject",
  CAKhoiTaoThucTheEndpoint:"https://221.132.34.198/api/cms/end-entity/save",
  CACapNhatThucTheEndpoint:"https://221.132.34.198/api/cms/end-entity/save",
  CATimKiemThucTheEndpoint:"https://221.132.34.198/api/cms/end-entity/list",
  CAKhoiTaoCauHinhEndpoint:"https://221.132.34.198/api/cms/end-entity/form",
  CALayChungThuSoEndpoint:"https://221.132.34.198/api/cms/cert/generate-certificate",
  CALayThongTinCAHienHuuEndpoint:"https://221.132.34.198/api/cms/cert/cert-endentity",
  CALayThongTinCAHienHuuEndpoint:"https://api-cams.vnpt-ca.vn/api/cms/cert/cert-endentity",
  CAKhoiTaoYeuCauCapMoiEndpoint:"https://221.132.34.198/api/cms/request-cert/request-info",
  CAKhoiTaoYeuCauCapNhatEndpoint:"https://221.132.34.198/api/cms/request-cert/request-info",
  CATaoYeuCauCapMoiEndpoint:"https://221.132.34.198/api/cms/request-cert/save/v2",
  CATaoYeuCauCapNhatEndpoint:"https://221.132.34.198/api/cms/request-cert/save/v2",
  CADuyetYeuCauEndpoint:"https://221.132.34.198/api/cms/request-cert/approve",
  CAHuyDuyetYeuCauEndpoint:"https://221.132.34.198/api/cms/request-cert/reject",
  CATimKiemYeuCauChungThu:"https://221.132.34.198/api/cms/request-cert/list",
  CAXemChiTietYeuCauChungThu:"https://221.132.34.198/api/cms/request-cert/detail",
  CAYeuCauGiaHanChungThuSoEndpoint:"https://221.132.34.198/api/cms/request-cert/save/v2",
  CAYeuCauThuHoiChungThuSoEndpoint:"https://221.132.34.198/api/cms/request-cert/save-revoke-and-ban-request",
  ReqTypeCapMoi:2,
  ReqTypeGiaHan:8,
  ReqTypeTatCa:-1,
...
export const KIEU_DL = {
    CST_TEXT: 0,
    CST_NUMBER: 1,
    CST_DATE: 2,
}
export const TrangThaiCaiDat =
{
    MOI: 0,
    DA_CAIDAT: 1,
}
export const TOCDO =
{
    ...
    MEGA_4GAME: 7,
    MEGA_DREAM: 8,
    HDDT_GOI_TREN_10000: 4784,
    HDDT_GOI_GIAIPHAP: 5153,
}
...
export const ITEM_TYPE = {
	...
	nFieldLength: 0,
	sValue: "",
	iAtt: 0, //0: Disable, 1: textbox, 2: Combo, 3: hien thi thong tin duoc lookup, 4: DTPicker, 5: Button, 7: Check, 9: Datepicker, 10: Multi Checked Combobox
	iDataType: 0, //0: Text, 1: Number, 2: data
	bIsNotNull: true,//True : accept null, false : not
	bIsUnique: true,
	sMaxValue: "",
	sMinvalue: "",
	sLookUpTableName: "", //Ten bang Lookup
	sLookUpKeyField: "", //Ten truong khoa, bang lookup
	sLookUpValueField: "", //
	StrSql: "",
	strDepandField: "",
	sLookupApi: "",
...
export const DS_KHOITAO_CHONSO_TS = {
    "-1":"Số thuê bao và số SIM không nằm cùng trên tổng đài nên không khởi tạo được. Bạn hãy chọn lại",
    "4":"Số thuê bao này đang chờ khởi tạo. Hãy chọn thuê bao khác",
    "5":"Số thuê bào này đang chờ khởi tạo hãy chọn thuê bao khác",
    "6":"Số MSIN  đã gán cho thuê bao khác",
    "7":"Không có thông tin người dùng",
    "8":"Mã xác thực không đúng",
    "9":"Không có thông tin mã tỉnh người dùng",
    "10":"Chỉ khởi tạo được với loại là Post",
    "11":"Thuê bao nằm trong dải số chỉ được khởi tạo là Mobibroadband trả sau",
    "12":"User chưa được phân quyền khởi tạo dải số này. Yêu cầu liên hệ với ADMIN tỉnh.",
    "19":"Loại thuê bao không được phép khởi tạo",
    "20":"Lỗi kích hoạt thuê bao trả trước qua Webservice"
}

export const LOAIKENH={
    LIENTINH:3,
    INTERNET_TRUCTIEP:1,
    NOIHAT:8,
    QUOCTE:4
