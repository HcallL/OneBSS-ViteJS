<template>
  <b-modal
    ref="popupCreateAgentSMSBrandname"
    size="xl"
    hide-header
    hide-header-close
    hide-footer
  ...
  >
    <div class="modal-content popup-box">
      <div class="popup-header">
        <div class="title">
          <span class="icon one-notepad"></span>Tạo khách hàng đại lý
        </div>
        <div
...
export default {
  name: "popupCreateAgentSMSBrandname",
  ...
  methods: {
    ...
    showModal: async function () {
      this.clear();
      this.$refs["popupCreateAgentSMSBrandname"].show();
      this.loading(true);
      try {
    ...
    hideModal: function () {
      this.$refs["popupCreateAgentSMSBrandname"].hide();
    },
