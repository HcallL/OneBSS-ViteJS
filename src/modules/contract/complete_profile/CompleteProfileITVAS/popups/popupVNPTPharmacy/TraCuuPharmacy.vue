  ...
  data() {
    return {
      ...
      ds_cuahang: {
        list: [],
        header: [
          { fieldName: 'MA_CH', headerText: 'Mã cửa hàng', allowFiltering: true, width: 130 },
      ...
      ds_user: {
        list: [],
        header: [
          { fieldName: 'USERID', headerText: 'User ID', allowFiltering: true, width: 150 },
      ...
      ds_thuebaocungdoicap: {
        list: [],
        header: [
          { fieldName: 'ma_tb', headerText: 'Mã TB', allowFiltering: true, width: 100 },
