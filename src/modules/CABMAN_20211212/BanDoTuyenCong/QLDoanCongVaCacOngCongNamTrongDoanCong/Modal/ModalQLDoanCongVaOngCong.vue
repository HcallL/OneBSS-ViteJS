...
<script>
    ...
    export default {
        ...
        props: ["modalId", "data"],
        components: {ModalChuiCap, moment,Panzoom},
        data: function () {
            return {
                componentName:null,
            ...
            veGianDoOngCong: function () {
                try {
                    ...
                    for (let i=0; i < this.dataSelected.soDongMatCat; i++) {
                        ...
                        //codetr = codetr == null ? "<tr id='"+idDong+"'>" : codetr + "<tr id='"+idDong+"'>"
