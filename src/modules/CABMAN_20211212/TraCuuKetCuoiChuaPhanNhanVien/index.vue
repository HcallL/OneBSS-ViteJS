...
import PhanViTriKetCuoiChoNhanVien from '../PhanViTriKetCuoiChoNhanVien/modal'
L10n.load({
  'vi-VN': {
    treegrid: {
...
export default {
  ...
  methods: {
    ...
    getDsKetCuoiChuaPhanNVPaging: async function (danhSachToQuanLyId, pageIndex, pageSize) {
    ...
    updateDsKetCuoiChuaPhanNVCount: async function (danhSachToQuanLyId) {
      await this.$root.context.post(
        `/web-cabman/tracuu/vitri-ketcuoi-chuaphan-nv-paging?danhSachToQuanLyId=${danhSachToQuanLyId}`,
        {
          pageIndex: 1,
