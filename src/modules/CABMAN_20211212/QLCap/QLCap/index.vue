...
export default {
  components:{ ModalTreoCap, ModalChuiCap, QuyHoachSoiCap, BssErrorMarker, BssRequiredMarker},
  name: "QLCap",
  props: {
    /***
      ...
      try {
        ...
        if (this.taomoiCap){
          ...
          await this.$root.context.post("web-cabman/mang-truyen-dan/capnhat-cap",this.cap)
            ...
            }).catch(e => this.$root.toastError("Có lỗi xảy ra trong quá trình cập nhật cáp"))
        }
      }catch (e){
        console.log(e)
      }finally {
