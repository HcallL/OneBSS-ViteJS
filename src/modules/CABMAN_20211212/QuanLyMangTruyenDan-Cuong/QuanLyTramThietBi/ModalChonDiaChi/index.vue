...
export default {
    ...
    methods: {
        ...
        thayDoiDiaChi: function() {
            ...
            this.diaChiForm = this.soNha.length > 0 ? this.soNha  + ', ' + this.diaChiForm : this.diaChiForm;
           
        },
        chapNhan: async function() {
            if((!this.isChk_duongpho && !this.isChk_ngoap && !this.isChk_khu) || (this.isChk_duongpho && !this.duongPho_id) || (this.isChk_ngoap && !this.ap_id) || (this.isChk_khu && !this.khu_id)) {
    ...
    mounted: async function() {
        try {
            ...
            console.log(this.chiTietDiaChi);
            this.dsThanhPho = rs.data;
            this.diaChiForm = this.diaChi;
            this.tinhThanh_id = this.chiTietDiaChi.tinhThanh_id ? this.chiTietDiaChi.tinhThanh_id : parseInt(this.$root.token.getPhanVungID());
