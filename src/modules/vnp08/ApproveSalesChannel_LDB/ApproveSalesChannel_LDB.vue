...
import Pheduyetphieugiao from "./popup/Pheduyet/Pheduyet.vue";
...
export default {
    ...
    methods: {
        ...
        async getDanhsach_DexuatHDKenh(){
            ...
            console.log('getDanhsach_DexuatHDKenh', this.grid_DeXuatKenhban.items)
        },
        async dsPhieuGiao(){
        ...
        Pheduyet_click(index, rowData) {
           this.$refs.PheDuyetModal.showModal();
        },
        Tuchoi_click(index, rowData) {
           this.$refs.TralaiModal.showModal();
        },
        Pheduyet(){
            this.$refs.PheDuyetModal.hideModal();
            this.getDanhsach_DexuatHDKenh();
        },
        Tralai(){
