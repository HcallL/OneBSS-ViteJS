...
export default [
  {
    ...
    children: [
      ...
      {
        path: 'tracuu-thueao-theodssplitter',
      ...
      {
        path: 'quy-hoach-interner-tructiep',
        name: 'QuyHoachSCVLANInternetTrucTiep',
        component: QuyHoachSCVLAN,
        meta: {
          title: 'Quy hoạch SCVLAN Interner Trực Tiếp'
        }
      },
      {
