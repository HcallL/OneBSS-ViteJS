...
export default {
    ...
    methods: {
        ...
        checkForm: function() {
            ...
            this.$toast.error('Hãng sản xuất bắt buộc nhập dữ liệu');
            return false;
        },
        nhapMoi: function() {
        ...
        xoa: function() {
            ...
            this.$bvModal.msgBoxConfirm('Xác nhận hành động', {
                title: 'Bạn có chắc chắn xóa hãng sản xuất này?',
                size: 'sm',
                centered: true,
                okTitle: 'Đồng ý',
                cancelTitle: 'Hủy'
                ...
                if(val) {
                    if(this.id) {
                        try {
                            ...
                            this.$root.toastError("Hãng sản xuất này đã được gán cho dslam, không thể xóa!");
                        }
                    }
                    else {
                        this.ten = null;
        ...
        closeModal: function() {
            this.$bvModal.hide('modal-hangsanxuat');
        }
    },
}
</script>
