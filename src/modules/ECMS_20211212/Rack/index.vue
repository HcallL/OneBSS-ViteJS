...
export default {
  ...
  methods: {
    ...
    onClickButtonNhapMoi () {
      ...
      this.rack = null
      this.shelf = null
      this.tableThongTinRack.data = null
    ...
    onClickButtonGhiLai: async function () {
      ...
      try {
        ...
        if (!this.buttonState.btnNhapMoiEnabled) {
          ...
          this.dsRack.forEach(element => element.STT = element.STT + 1)
          result.STT = 1
          this.dsRack.unshift(result)
          this.tableThongTinRack.data = this.dsRack
          ...
          // this.dsRack = dsRackTmp
          // this.commit('setDsRack', dsRackTmp)
