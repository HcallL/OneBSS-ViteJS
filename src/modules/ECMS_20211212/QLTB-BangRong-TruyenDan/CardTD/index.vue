    ...
    methods: {
        ...
        themApi: async function(){
            ...
            let data = {
                ...
                P_LOAICARD_ID: this.currentItem.LOAICARD_ID,
                P_FRAMETD_ID: this.frametd_id,
                P_VITRI: this.vitri,
                P_PORT_BD: this.currentItem.PORT_BD,
                P_SERIAL: this.currentItem.SERIAL,
                P_PARTNUMBER: this.currentItem.PARTNUMBER,
        ...
        capnhatApi: async function(){
            let data = {
                P_PHANVUNG_ID: this.$root.token.getPhanVungID(),
                P_CARDTD_ID: this.cardtd_id,
                P_LOAICARD_ID: this.currentItem.LOAICARD_ID,
                P_FRAMETD_ID: this.frametd_id,
                P_VITRI: this.vitri,
                P_PORT_BD: this.currentItem.PORT_BD,
                P_SERIAL: this.currentItem.PARTNUMBER,
                P_PARTNUMBER: this.currentItem.PARTNUMBER,
        ...
        LayThongTinFrame_Card: async function (cardtd_id){
            ...
            let dtInfo = await this.$root.context.post('/web-cabman/ban-do-mang-cap/execute1', data)
            return dtInfo.data;
        },
