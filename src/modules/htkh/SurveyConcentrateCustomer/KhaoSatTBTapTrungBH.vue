                ...
                <div class="box-form">
                    ...
                    <div v-show="isExpandedTTTB">
                        ...
                        <div class="info-row">
                            ...
                            <div class="value">
                                <div class="input-more-button">
                                    <a :href="`tel:${input_sdt_kh}`" class="btn">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-12">
                                <div class="info-row">
                                    ...
                                    <div class="value">
                                        <div class="input-more-button">
                                            <a :href="`tel:${input_sdt_baohong}`" class="btn">
                                                <span class="icon one-mobile-plus"></span>
                                            </a>
...
export default {
    ...
    methods:{
        ...
        async TaoDuLieu(themmoi, xuatlai){
            ...
            if(themmoi){
                object.NGAY_HOI = moment(new Date()).format('DD/MM/YYYY')
            }else{
        ...
        async KiemTra_DuLieu(themmoi){
            ...
            if(this.chkKhongTL.Check&&!this.cboLyDoKTL.value){
