...
export default {
    ...
    methods: {
        ...
        async TaoDuLieu(themmoi)
        {
            ...
            await this.TaoDuLieu_HDTB_KV(themmoi);
        ...
        async TaoDuLieu_HDKH(themmoi)
        {
            ...
            if (themmoi == true)
            {
                this.txtMaGD = this.GetData(await api.sinh_magd(this.axios, {"loaihd_id":38}));
            ...
            try
            {
                this.$bvModal.msgBoxConfirm('Bạn thật sự muốn xóa phiếu yêu cầu khảo sát này không ?', {
                    ...
                    if(v) {
                        ...
                        await this.HienThiDanhSacHDTB(this.txtMaGD);
                        this.SetButton(0);
                    ...
                    this.$bvModal.msgBoxConfirm('Bạn thật sự muốn hoàn thành phiếu yêu cầu khảo sát không ?', {
                        ...
                        if(v) {
                            let ds = this.GetData(await api.hoanthiendonhang_18001166(this.axios,  {
                                "p_phanvung_id": this.tt_nd.phanvung_id,
                                "p_hdkh_id": this.hdkh_id,
