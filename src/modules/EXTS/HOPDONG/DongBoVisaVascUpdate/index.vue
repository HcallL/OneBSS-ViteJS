...
export default {
  ...
  methods: {
    ...
    KIEMTRA_TB_DONGBO_EPG_VTT: async function (account, ngayth) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_tb_dongbo_epg_vtt",
          {
            account: account,
            ngayth: ngayth
          }
    ...
    Kt_thuebao_goi_giadinh: async function (hdtb_id, thuebao_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/hths-thaydoi-tocdo/sp_kt_thuebao_goi_giadinh",
          {
    ...
    kt_mytv_moi: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kt_mytv_moi/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        console.log(error)
    ...
    kiemtra_tb_cs_roimang: async function (hdtb_id, nhanvien_cs_id = 0) {
      ...
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_tb_cs_roimang",
          {
            hdtb_id: hdtb_id,
    ...
    lay_matocdo_by_hdtb_id: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_matocdo_by_hdtb_id/" + hdtb_id
        );
    ...
    lay_matocdo_by_hdtb_idv2: async function (hdtb_id) {
      try {
        //Gọi api ngoài
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_matocdo_by_hdtb_idv2/" + hdtb_id
        );
        if (rs.data != null) return rs.data[0];
      } catch (error) {
        return null;
    ...
    Kiemtra_dk_dvgt_th_faf: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/Kiemtra_dk_dvgt_th_faf/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        return null;
    ...
    kt_dangky_paytv: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kt_dangky_paytv/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        return null;
    ...
    Kiemtra_dk_combo_fafilm: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/Kiemtra_dk_combo_fafilm/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        return null;
    ...
    KIEMTRA_KICHHOAT_VISA: async function (thuebao_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_kichhoat_visa/" + thuebao_id
        );
        return rs.data;
      } catch (error) {
        return 0;
    ...
    KichHoat_ThanhLy: async function (account, lydo, chuthich, in_loaitb_id, in_hdtb_id) {
      ...
      try {
        ...
        if (
          ...
          in_loaitb_id == Enum.LoaiHinhTB.MegaIOT
        ) {
          ...
          if (kieu_mega != "0") {
            ...
            if (ktra) {
              //HungVV : Cập nhật gọi đăng ký DangKyV2
              ...
              let province = this.$root.context.user.getProperty("tentat_vasc");
              ...
              //Gọi lệnh đổi profile     
              //TODO: change green netttttt
              if (!this.changeGreenNet(0)) {
                this.$root.toastError("Lỗi khi gửi lệnh thay đổi profile thuê bao đăng ký GreenOnline !");
                return false;
              }
              ...
              if (kq != 1) {
                ...
                this.$root.toastSuccess(
                  "Hủy kích hoạt GreenOnline thành công !"
                );
    ...
    TTCT_DichVuGT: async function (dichvugt_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/ttct_dichvugt_id/" + dichvugt_id
        );
        return rs.data[0];
      } catch (error) {
        return null;
    ...
    KIEMTRA_TB_SD_DVGT: async function (thuebao_id, dichvugt_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_tb_sd_dvgt",
          {
            thuebao_id: thuebao_id,
    ...
    KIEMTRA_TB_DK_DVGT: async function (hdtb_id, dichvugt_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_tb_dk_dvgt",
          {
            hdtb_id: hdtb_id,
            dichvugt_id: dichvugt_id,
          }
    ...
    CAPNHAT_STATUS_HDTB: async function (hdtb_id, status) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/capnhat_trangthai_hdtb",
          {
            hdtb_id: hdtb_id,
            status: status,
          }
    ...
    lay_ds_goi_mytvtitan: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_goi_mytvtitan/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        return null;
    ...
    kt_thaydoi_tocdo_khdn: async function (hdtb_id, tocdo_cu_id, vthuebao_id, tocdo_id, thamso) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/kt_thaydoi_tocdo_khdn", {
          hdtb_id: hdtb_id,
    ...
    update_hdtb_adsl: async function (hdtb_id, dslam_id, bras_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/update_hdtb_adsl", {
          hdtb_id: hdtb_id,
          dslam_id: dslam_id,
          bras_id: bras_id
        }
    ...
    lay_ds_biendong: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_biendong/" + hdtb_id
        );
        return rs.data
      } catch (error) {
      } finally {
    ...
    UPDATE_IP_ADSL: async function (hdtb_id, ip) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/update_ip_adsl", {
          hdtb_id: hdtb_id,
          ip: ip
        }
        );
    ...
    LAY_DS_THAMSO_MD_MATS: async function (ma_ts) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/khaibaotsl/lay_ds_thamso_md_mats", {
          ma_ts: ma_ts
        }
        );
        return rs.data
    ...
    LAY_GOI_DIDONG: async function (thuebao_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_goi_didong/" + thuebao_id
        );
        return rs.data
      } catch (error) {
      } finally {
    ...
    demKyHoaDon: async function (vkyhoadon) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/hoanthien-hs-tachnhap-tbao/ktra_taodb_thang",
          { kyhoadon: vkyhoadon }
        );
        if (rs.data != null) {
          return rs.data[0].kq
    ...
    KIEMTRA_GIAO_OMC: async function (hdtb_id, index_loaitb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_giao_omc",
          {
            hdtb_id: hdtb_id,
    ...
    GIAOPHIEU_TIEPTHEO: async function (hdtb_id, phieu_id, huonggiao_id, kieu) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/giaophieu_donvi_tieptheo",
          {
            hdtb_id: hdtb_id,
            phieu_id: phieu_id,
    ...
    CAPNHAT_NGAYHT: async function (hdtb_id) {
      let rs = await this.$root.context.post(
        "/web-hopdong/dongbo-visa-vasc/update_ngay_ht/" + hdtb_id
      );
    },
    CAPNHAT_NGAYKH: async function (hdtb_id) {
      let rs = await this.$root.context.post(
        "/web-hopdong/dongbo-visa-vasc/update_ngay_kh/" + hdtb_id
      );
    },
    HOANTHANH_HOANCONG: async function (hdtb_id, phieu_id, tthd_dich_id) {
      let rs = await this.$root.context.post(
        "/web-hopdong/dongbo-visa-vasc/hoanthanh_hoancong", {
        hdtb_id: hdtb_id,
        phieu_id: phieu_id,
    ...
    CapNhat_TT_Phieu_HTHS: async function (hdtb_id) {
      let rs = await this.$root.context.post(
        "/web-hopdong/dongbo-visa-vasc/capnhat_tt_phieu_hths/" + hdtb_id
      );
    },
    CN_NGAY_BD_NGAY_HUY: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/cn_ngay_bd_ngay_huy/" + hdtb_id
        );
        return rs.data;
      } catch (error) {
        return null
    ...
    HoanCong: async function () {
      try {
        ...
        console.log("this.loaihd_id12:", this.loaihd_id)
        if (this.loaihd_id == Enum.LoaiHopDong.THAY_DOI_DV) {
          console.log("this.PHAILAM:", this.PHAILAM("HOANCONG"))
          if (this.PHAILAM("HOANCONG")) {
            ...
            console.log("this.dsphieu:", dsphieu)
            ...
            if (this.PHAILAM("TUDONG_HTHS")) {
              ...
              //#region Kiểm tra và hủy gói Kas cho thuê bao Fiber
              ...
              if (this.loaitb_id == Enum.LoaiHinhTB.INTERNET_FTTH ||
                ...
                this.loaitb_id == Enum.LoaiHinhTB.MegaIOT) {
                let dsKtra = await this.kiemtra_huygoi_kaspersky(this.hdtb_id);
                if (dsKtra != null && dsKtra.length > 0) {
                  if (this.getValueFromIndex(dsKtra[0], 0) == "1") {
                    let goi_id = parseInt(this.getValueFromIndex(dsKtra[0], 1));
                    let nhomtb_id = parseInt(this.getValueFromIndex(dsKtra[0], 2));
                    await this.TaoDuLieu_huygoi_kaspersky(goi_id, nhomtb_id, Enum.KieuLapDat.XOA_TB_GOI_DADV);
                    if (this.HuyGoi_Kas("agg_close")) {
                      await this.CAPNHAT_STATUS_HDTB(this.hdtb_id, Enum.TRANGTHAI_DONGBO.DONGBO_CM);
                      await this.HOANTHIEN_HS_TD_GOI_DADV(this.hdkh_id_huygoi_mytv);
                    } else {
                      this.$root.toastError("Có lỗi trong quá trình kích hoạt gói Kaspersky lên hệ thống của VTC!");
                    }
                  }
                }
              }
        ...
        if (parseInt(this.loaihd_id) == Enum.LoaiHopDong.THAY_DOI_TOCDO_ADSL) {
          ...
          if (this.PHAILAM("TUDONG_HTHS")) {
            let thangnam;
            if (this.currentItem.ngay_kh != "" && this.currentItem.ngay_kh != null) {
              thangnam = this.currentItem.ngay_kh.substring(3, this.currentItem.ngay_kh.length)
            }
            if (parseInt(this.currentItem.tucthi) == 0 && this.currentItem.ngay_kh != "") {
              if (thangnam == DateTimeLib.toDateDisplayWithFormat(new Date(), 'MM/yyyy')) {
                this.$root.toastError("Không được hoàn công và hoàn thiện trong tháng " +
                  DateTimeLib.toDateDisplayWithFormat(new Date(), 'MM/yyyy') + " !");
                return;
              }
            }
            //end hoang them
          ...
          if (this.PHAILAM("TUDONG_GIAOPHIEU_DUYET_CAPVT")) {
            await this.GIAOPHIEU_TD_TAOPHIEU_DUYET_VT(this.hdtb_id, this.phieu_id);
          }
          if (this.PHAILAM("TUDONG_THUHOI_KHI_HOANCONG")) {
            await this.GIAOPHIEU_TD_HOST_THUHOI_1(this.hdtb_id, this.phieu_id);
          }
              ...
              if (this.PHAILAM("CHECK_OMC")) // Nếu có thao tác kiểm tra OMC thì -> làm
              {
                try {
                  ...
                  else if (kq.toString() == "2")// bo qua
                  {
                    ...
                    await this.xuLyHoanCongNgay(in_hdtb_id, in_phieu_id, str)
                  }
    ...
    lay_kieu_yc: async function (hdtb_id, idsDichvu) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_kieu_yc", {
          hdtb_id: hdtb_id,
          idsDichvu: idsDichvu
        }
        );
    ...
    xuLyHoanCongNgay: async function (in_hdtb_id, in_phieu_id, str) {
    ...
    Kiemtra_yc_giaophieu_doitocdo: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/Kiemtra_yc_giaophieu_doitocdo/" + hdtb_id
        );
        return rs.data
      } catch (error) {
        return null
    ...
    HoanThienHoSo_DV: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/hoanthienhoso_dichvu/" + hdtb_id
        );
      } catch (e) {
        console.log(e)
      }
    ...
    HoanThienHoSo_TocDo: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/hoanthienhoso_tocdo/" + hdtb_id
        );
      } catch (e) {
        console.log(e)
      }
    ...
    LAY_TT_GOI_GDVP: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_tt_goi_gdvp/" + hdtb_id,
        );
        return rs.data
      } catch (error) {
        return {
    ...
    CAPNHAT_NGAYKH_STATUS_V2: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/tiepnhanhopdong/capnhat_ngaykh_status_v2",
          {
            hdtb_id: hdtb_id,
    ...
    Lay_DonVi_GiaoPhieu_HTHS: async function (huonggiao_id, hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_donvi_giaophieu_hths/" + hdtb_id
        );
        return rs.data
      } catch (error) {
        return null;
    ...
    Lay_DonVi_GiaoPhieu: async function (huonggiao_id, hdtb_id) {
      try {
        ...
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_donvi_giaophieu",
          {
            hdtb_id: hdtb_id,
            huonggiao_id: huonggiao_id
          }
    ...
    KiemTra_Phieu_DaGiao: async function (hdtb_id, huonggiao_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_phieu_dagiao?hdtb_id=" + hdtb_id + "&huonggiao_id=" + huonggiao_id,
        );
        console.log(rs)
    ...
    LAY_DS_DB_ADSL_THEO_TBID: async function (thuebao_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/tracu-danhba/ds_adsl_tb/" + thuebao_id,
        );
        return rs.data
      } catch (error) {
        return null
    ...
    LAY_DS_DB_MEGAEYES_THEO_TBID: async function (thuebao_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_db_megaeyes_theo_tbid/" + thuebao_id
        );
        return rs.data
      } catch (error) {
        return null;
    ...
    ktra_dk_port: async function (ma_tb, port_id, vci_vpi_id, kieu) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/ktra_dk_port",
          {
            ma_tb: ma_tb,
            port_id: port_id,
    ...
    CapNhat_TrangThai_Port: async function (port_id, vci_vpi, trangthai) {
      try {
        await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/CapNhat_TrangThai_Port",
          {
            port_id: port_id,
            vci_vpi: vci_vpi,
            trangthai: trangthai
    ...
    CapNhat_TrangThai_PortID: async function (port_id, trangthai) {
      try {
        await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/CapNhat_TrangThai_PortID",
          {
            port_id: port_id,
            trangthai: trangthai
          }
    ...
    CapNhat_ds_matb: async function (port_id, vci_vpi, vds_matb) {
      try {
        await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/CapNhat_ds_matb",
          {
            port_id: port_id,
            vci_vpi: vci_vpi,
            ds_matb: vds_matb
    ...
    Capnhat_port_vatly: async function (port_id, trangthai) {
      try {
        await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/Capnhat_port_vatly",
          {
            port_id: port_id,
            trangthai: trangthai
          }
    ...
    HOANTHIEN_HS_CHAMDUT_SD: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/hoanthien_hs_chamdut_sd?hdtb_id=" + hdtb_id
        );
      } catch (e) {
        console.log(e)
      }
    ...
    CapNhat_TT_Phieu_GPhone: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/capnhat_tt_phieu_gphone?hdtb_id=" + hdtb_id
        );
      } catch (e) {
        console.log(e)
      }
    ...
    GIAOPHIEU_TD_HOST_THUHOI_1: async function (hdtb_id, phieu_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/giaophieu_td_host_thuhoi_1?hdtb_id=" + hdtb_id + "&phieu_id=" + phieu_id
        );
      } catch (e) {
        console.log(e)
      }
    },
    GIAOPHIEU_TD_TAOPHIEU_DUYET_VT: async function (hdtb_id, phieu_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/tiepnhanhopdong/giaophieu_td_taophieu_duyetvt",
          {
            hdtb_id: hdtb_id,
            baohong_id: 0,
            phieu_id: phieu_id,
            donvi_giao_id: this.$root.token.getIDDonVi(),
    ...
    hoangcong_hopdong_bancheo: async function (in_hdtb_id) {
      ...
      if (ds[0].hdtb_ban > 0) {
        ...
        if (ds2 == null || ds2.length == 0) return;
        if (ds2[0].loaihd_id == Enum.LoaiHopDong.DAT_MOI && ds2[0].thuebao_id_thicong != '-1') {
          if (ds2[0].dichvuvt_id != Enum.DichVuVienThong.TSL) {
            ...
            for (let i = 0; i < ds2.length; i++) {
              ...
              await this.them_db_bancheo(ds2[i].thuebao_id_thicong, ds2[i].thuebao_id_ban, ds2[i].tinh_ban, 2);
            }
          }
        }
      }
    ...
    tinh_thicong: async function (tinh_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/tinh_thicong/" + tinh_id
        );
    ...
    hoancong_hopdong_bancheo_v3: async function (hdtb_ban, khachhang_tc_id,
      ...
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/hoancong_hopdong_bancheo_v3",
          {
            hdtb_id: hdtb_ban,
    ...
    HOANCONG_THICONG_2: async function (in_hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/hoancong_thicong_2/" + in_hdtb_id
        );
        return rs.data
      } catch (error) {
        return null
    ...
    BENBAN_HOANTHIEN: async function (in_hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/benban_hoanthien/" + in_hdtb_id
        );
        return rs.data
      } catch (error) {
        return null
    ...
    them_db_bancheo: async function (thuebao_id, thuebao_kn_id, tinh_kn_id, loai_bc) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/them_db_bancheo", {
          thuebao_id: thuebao_id,
    ...
    kiemtra_vattu_cap: async function (hdtb_id) {
      let rs = await this.$root.context.get(
        "/web-hopdong/dongbo-visa-vasc/kiemtra_vattu_cap/" + hdtb_id
      );
      if (rs.data != null && rs.data.length > 0)
        return true
      else
    ...
    giaophieu_td_taophieu_vtttkd: async function (in_hdtb_id, in_phieu_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/giaophieu_td_taophieu_vtttkd",
          {
            hdtb_id: in_hdtb_id,
            phieu_id: in_phieu_id
          }
    ...
    Kiemtra_huygoi_mytv_tddv: async function (index_hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/Kiemtra_huygoi_mytv_tddv/" + index_hdtb_id,
        );
        return rs.data
      } catch (error) {
      }
    ...
    kiemtra_huygoi_kaspersky: async function (index_hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_huygoi_kaspersky/" + index_hdtb_id,
        );
        return rs.data
      } catch (error) {
      }
    ...
    LayThueBaoChuNhom_GDVP: async function () {
      try {
        ...
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/laythuebaochunhom_gdvp", { ma_tb: vma_tb },
        );
        let ds = rs.data
        if (ds == null) return ''
        for (let i = 0; i < ds.length; i++) {
    ...
    LayMaGoi: async function (goi_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/laymagoi/" + goi_id
        );
        if (rs.data != null && rs.data.length > 0)
    ...
    LayThueBaoFiber: async function () {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/laythuebaofiber",
          { ma_tb: this.account },
        );
    ...
    ThemHDKH: async function (data_hdkh) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/them_hd_khachhang", data_hdkh
        );
        let ds = rs.data
        if (ds != null)
          return ds[0]
    ...
    ThemHDTB: async function (data_hdtb) {
      try {
        ...
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/them_hd_thuebao", data_hdtb
        );
    ...
    ThemHDTBGOI: async function (data_goi) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/them_hd_thuebao_goi", data_goi
        );
        if (rs.data != null)
          return rs.data[0]
        return null
    ...
    CAPNHAT_BIENDONG: async function () {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/capnhat_biendong/" + this.hdtb_id_huygoi_mytv
        );
        return rs.data
      } catch (error) {
        return null
    ...
    CHUYEN_DL_HDTB_SANG_GIAOPHIEU: async function () {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/chuyen_dl_hdtb_sang_giaophieu",
          {
    ...
    Lay_Ma_GD: async function (ma_tb) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/laythuebaofiber/" + ma_tb,
        );
    ...
    Sinh_Ma_GD: async function (loaihd_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/chuyendich/sinh_magd", {
          loaihd_id: loaihd_id
        }
        );
    ...
    TaoDuLieu_HDKH_huygoi_mytv: async function () {
      ...
      this.hdkh_id_huygoi_mytv = await this.getKey("HD_KHACHHANG");
      ...
      rowHDKH.hdkh_id = this.hdkh_id_huygoi_mytv;
      rowHDKH.ma_gd = await this.Sinh_Ma_GD(Enum.LoaiHopDong.THAYDOI_GOI_DADV);
    ...
    TaoDuLieu_HDTB_huygoi_mytv: async function (kieuld_id) {
      this.hdtb_id_huygoi_mytv = await this.getKey("HD_THUEBAO");
      // let hdkh_id_huygoi_mytv = 0
    ...
    HOANTHIEN_HS_TD_GOI_DADV: async function (hdkh_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/hoanthien_hs_td_goi_dadv/" + hdkh_id
        );
      } catch (e) {
        console.log(e)
      }
    ...
    kiemtra_huygoi_thanhly: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/kiemtra_huygoi_thanhly/" + hdtb_id
        );
        return rs.data
      } catch (error) {
        return null;
    ...
    ktra_tocdo_dk_greennet: async function (tocdo_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-tracuu/hopdong/fn_ktra_tocdo_dk_greennet", {
          tocdo_id: tocdo_id
        }
        );
        if (rs.error_code === 'BSS-00000000') {
          return Number(rs.data);
        }
        else {
          return 0;
        }
    ...
    DongBo: async function () {
      ...
      if (this.loaihd_id == Enum.LoaiHopDong.THAY_DOI_TOCDO_ADSL) {
        let t_tocdo_id = await this.lay_tocdo_id(this.hdtb_id);
        let ck_check_greennet = await this.ktra_tocdo_dk_greennet(t_tocdo_id);
        if (ck_check_greennet == 1) {
          let t_ktra = await this.KIEMTRA_TB_DK_DVGT(this.hdtb_id, Enum.DichVuGiaTang.GREEN_ONLINE_NET);
          if (!t_ktra) {
            this.$root.toastError("Gói cước có bao gồm dịch vụ GreenNet. Đề nghị khai báo Dịch vụ GTGT Green Net trước khi khởi tạo gói cước");
            return;
          }
        }
        let s = "";
            ...
            try {
              ...
              if (!this.dongbo_test && kieu_mega != "0") {
                ...
                if (
                  ...
                  let tocdo_id = "";
                  let tocdo_cu_id = "";
                  console.log("dsThueBao33:", this.dsThueBao.length);
                  ...
                  if (this.dsThueBao.length > 0) {
                    ...
                    if (kieu_mega == "1") {
                      ...
                      // #region Thay đổi tốc độ
                        ...
                        //#region bổ sung theo trao đổi meet với Phương + Duy
                        if (ck_check_greennet == 1) {
                          if (!this.changeGreenNet(1)) {
                            this.$root.toastError("Lỗi khi gửi lệnh thay đổi profile thuê bao đăng ký GreenNet !");
                            return;
                          }
                          ...
                          if (kq != 1) {
                            ...
                            this.$root.toastSuccess(
                              "Kích hoạt đăng ký GreenNet thành công !"
                            );
                          }
                        }
                        //  #endregion
        ...
        this.$confirm(
          ...
          .then(async () => {
            try {
              ...
              console.log('kieu_mega11', kieu_mega)
              //CƯờng thấy dài quá phải region lại chóng mặt quá
              if (!this.dongbo_test && kieu_mega != "0") {
                console.log('this.dongbo_test:', this.dongbo_test)
                console.log(' this.lvwDVGT.length:', this.lvwDVGT.length)
                let thaydoidv_b2b = false;
                //Dich vu vien thong la ADSL
                let l_items = this.lvwDVGT;
                if(l_items.length == 0 && (this.kieuld_id == Enum.KieuLapDat.MOTAMDUNG_SD_MEGA || this.kieuld_id == Enum.KieuLapDat.MOTAMDUNG_SD_FIBER)) {
                  l_items = await this.LAY_DS_SUDUNG_DVGT(this.hdtb_id);
                  l_items.forEach(l_item => {
                    l_item.kieu_yc = "0";
                  });
                }
                for (let i = 0; i < l_items.length; i++) {
                  let item = l_items[i];
                  console.log('item.dichvugt_id:', item.dichvugt_id)
                  ...
                  if (
                    ...
                    console.log('this.nhantin_nhanvien_diaban :', this.nhantin_nhanvien_diaban)
                    ...
                    //async_status = true
                    //Thue bao MyTV
                    console.log("this.loaitb_id22:", this.loaitb_id)
                    if (
                      this.loaitb_id == Enum.LoaiHinhTB.INTERNET_MYTV ||
                      this.loaitb_id == Enum.LoaiHinhTB.INTERNET_MYTV_B2B
                    ) {
                      console.log("3433", this.loaitb_id)
                    ...
                    if (
                      ...
                      //Bổ sung như trao đổi với Phương và Duy
                      if (this.async_status) {
                        let vthuebao_id = await this.checkMapId_new(this.hdtb_id, 8)
                        let t_ktra = await this.KIEMTRA_TB_SD_DVGT(vthuebao_id, Enum.DichVuGiaTang.GREEN_ONLINE);
                        if (!t_ktra) {
                          t_ktra = await this.KIEMTRA_TB_SD_DVGT(vthuebao_id, Enum.DichVuGiaTang.GREEN_ONLINE_NET);
                        }
                        if (t_ktra) {
                          if (ck_check_greennet == 1) {
                            if (!this.changeGreenNet(1)) {
                  ...
                  // hoangpkn : 28/07/2015
                  else if (item.dichvugt_id == Enum.DichVuGiaTang.GREEN_ONLINE || item.dichvugt_id == Enum.DichVuGiaTang.GREEN_ONLINE_NET) {
                    console.log('13')
                    //#region Greeen
                    if (item.kieu_yc == "1") {
                      // đăng ký GreenOnline
                  ...
                  console.log("dddd", this.loaitb_id)
                  if (
                    this.loaitb_id == Enum.LoaiHinhTB.INTERNET_MYTV &&
                    this.loaihd_id == Enum.LoaiHopDong.THAY_DOI_DV
                  ) {
                    console.log('14')
                    ...
                    if (_dt != null && _dt.length > 0) {
                      ...
                      console.log("obj_ChangePackageV3:", obj_ChangePackageV3)
    ...
    lay_tocdo_id: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_tocdo_id/" + hdtb_id
        );
        return rs.data
      } catch (error) {
      } finally {
    ...
    lay_lydo_huy: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_lydo_huy/" + hdtb_id
        );
        if (rs.data != null && rs.data.length > 0)
    ...
    Lay_ds_hdtb_gd_kichhoat_madg: async function (ma_dg) {
      ...
      let rs = await this.$root.context.post(
        "/web-hopdong/dongbo-visa-vasc/lay_ds_hdtb_gd_kichhoat_madg",
        data
      );
    ...
    HT_Tocdo_Adsl_Combobox: async function () {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_tocdo"
        );
    ...
    HT_MucCuoc_Adsl_Combobox: async function () {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_muccuoc"
        );
    ...
    LAY_DS_HDTB_ADSL_THEO_HDTB_ID: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_hdtb_adsl_theo_id/" + hdtb_id
        );
        if (rs.data != null) return rs.data[0];
        else return null;
      } catch (error) {
    ...
    LAY_DS_SUDUNG_DVGT: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/lay_ds_sudung_dvgt", {
            id: hdtb_id
          }
        );
        return rs.data;
    ...
    Lay_DS_LoaiHinh: async function (dvvt_id) {
      try {
        ...
        if (rs.data != null) {
          this.loaitb_id = rs.data[0].loaitb_id;
        }
      } catch (error) {
      } finally {
      }
    ...
    HOANTHIEN_HS_THAYDOI_MATB: async function (hdtb_id) {
      try {
        let rs = await this.$root.context.post(
          "/web-hopdong/dongbo-visa-vasc/hoanthien_hs_thaydoi_matb/" + hdtb_id
        );
        if (rs.data != null) return rs.data[0];
        else return null;
      } catch (error) {
    ...
    lay_thongtin_dbkhachhang: async function (thuebao_id) {
      try {
        let rs = await this.$root.context.get(
          "/web-hopdong/dongbo-visa-vasc/lay_thongtin_dbkhachhang/" + thuebao_id,
        );
        if (rs.data != null && rs.data.length > 0)
          return rs.data[0]
        return rs.data
    ...
    HuyKichHoat: async function () {
      try {
        ...
        this.$root.showLoading(true);
        this.loaitb_id = Int32.Parse(this.currentItem.loaitb_id);
        this.kieuld_id = Int32.Parse(this.currentItem.kieuld_id);
        this.hdtb_id = Int32.Parse(this.currentItem.hdtb_id);
        if (this.loaihd_id == Enum.LoaiHopDong.CHAMDUT_SD) {
          if (this.dongbo_test == false) {
            ...
            await this.$bvModal
              .msgBoxConfirm("Bạn có chắc chắn hủy kích hoạt thanh lý Account không?", {
                title: "Thông báo",
                centered: true,
                size: "md",
                okTitle: "Có",
    ...
    Update_Table: async function (type, hdtb_id) {
      if (type == 0)
        await this.$root.context.get(
          `/web-hopdong/dongbo-visa-vasc/update_null_ngay_ht/${hdtb_id}`
        );
      else if (type == 1)
        await this.$root.context.get(
          `/web-hopdong/dongbo-visa-vasc/update_null_ngay_kh/${hdtb_id}`
        );
      else if (type == 2)
        await this.$root.context.get(
          `/web-hopdong/dongbo-visa-vasc/update_null_ngay/${hdtb_id}`
        );
    },
    Huy_KichHoat_ThanhLy: async function (account, lydo, chuthich, in_loaitb_id, in_hdtb_id) {
      let status = false;
      try {
        if ((in_loaitb_id == LoaiHinhTB.INTERNET_FTTH) || (in_loaitb_id == LoaiHinhTB.WIFI_FIBER) || in_loaitb_id == LoaiHinhTB.INTERNET_ADSL || in_loaitb_id == LoaiHinhTB.MegaIOT) {
          ...
          if (ktra == true) {
            ...
            if (kq != 1) {
              this.$root.toastError(
                "Có lỗi trong quá trình Kích hoạt dịch vụ GreenOnline trên hệ thống!");
              return false;
            } else {
              this.$root.toastSuccess(
                "Kích hoạt GreenOnline thành công !"
              );
              await this.CAPNHAT_NGAYKH_NGAY_HT_V2(this.hdtb_id);
            }
            // let kt = 0;
    ...
    TaoDuLieu_HDTB_huygoi_kas: async function (kieuld_id) {
      let rowHDTB = new Object();
      this.hdtb_id_huygoi_mytv = await this.getKey("HD_THUEBAO");
      let db_thuebao = await this.LAY_THONGTIN_DBTHUEBAO(this.thuebao_id);
      ...
      rowHDTB.TEN_TB = db_thuebao.ten_tb;
      rowHDTB.DIACHI_TB = db_thuebao.diachi_tb;
      rowHDTB.KIEULD_ID = kieuld_id;
      rowHDTB.DOITUONG_ID = db_thuebao.doituong_id;
      rowHDTB.TTHD_ID = 1 //TrangThaiHD.MOI
      rowHDTB.LOAITB_ID = this.index_loaitb_id;
      this.DICHVUVT_ID = this.dichvuvt_id;
      rowHDTB.DONVI_ID = this.$root.token.getIDDonVi();
      rowHDTB.NGUOI_CN = this.$root.token.getUserName();
      rowHDTB.NGAY_CN = DateTimeLib.toDateDisplay(new Date());
      rowHDTB.MAY_CN = "";

      let dset = await this.LayHuongGiao_TiepNhan(Enum.LoaiHopDong.THAYDOI_GOI_DADV, kieuld_id);
      let huonggiaotn_id;
      let quytrinh_id_2;
      if (!dset && dset.length > 0) {
        huonggiaotn_id = dset[0].huonggiao_id;
        quytrinh_id_2 = dset[0].quytrinh_id;
      }
    ...
    TaoDuLieu_huygoi_kaspersky: async function (goi_id, nhomtb_id, kieuld_id) {
      let data_hdkh = await this.TaoDuLieu_HDKH_huygoi_mytv();
      let hdkh = await this.ThemHDKH(data_hdkh)
      this.hdkh_id_huygoi_mytv = hdkh.hdkh_id
      let data_hdtb = await this.TaoDuLieu_HDTB_huygoi_kas(kieuld_id);
      let hdtb = await this.ThemHDTB(data_hdtb)
      this.hdtb_id_huygoi_mytv = hdtb.hdtb_id
      await this.CAPNHAT_BIENDONG()
      await this.CHUYEN_DL_HDTB_SANG_GIAOPHIEU()
    ...
    HuyGoi_Kas: async function (reason) {
      let rs = await this.$root.context.post("/tichhop/vtc/vnptfiber/ngung_dichvu",
        {
          custCode: this.account,
          reason: reason
        }
      );
      if (rs.error_code != 0) {
    ...
    changeGreenNet: async function (status) {
      let rs = await this.$root.context.post("/tichhop/visa-com/changeGreenNet",
        {
