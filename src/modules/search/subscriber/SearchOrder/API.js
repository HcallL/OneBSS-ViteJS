export default {
  ...
  getDSNhanVienTheoDonVi: (axios,data) => axios.post('/web-thicong/quanlydonhang/sp_lay_ds_nhanvien_theo_dv_xulydon',data),
  getTrangThaiHD: (axios,data) =>  axios.get('/web-tracuu/danhmuc/trangthai_hd'),
  loadDonHang: (axios,data) => axios.post('/web-thicong/quanlydonhang/fn_tracuu_donhang',data),
