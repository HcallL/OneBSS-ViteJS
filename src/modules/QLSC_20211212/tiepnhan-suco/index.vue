    ...
    methods: {
        ...
        onClickBtnGiaoPhieu() {
            if (this.btnGiaoPhieu.enabled) {
                this.$refs['ref-modal-giao-phieu'].show()
            }
        },
                    ...
                    if (this.tam) {
                        ...
                        if (!this.maSuCo) {
                            let data = {
                                ...
                                henSuaTu: !this.henTlTu ? null : this.yyyymmddhhmmssminus(this.henTlTu),
                                henSuaDen: !this.henTlDen ? null : this.yyyymmddhhmmssminus(this.henTlDen),
        ...
        async napDsTinhTrang(suCoId) {
            ...
            if (this.nhomSuCoId == 0) {
                await napDsTinhTrangCntt(suCoId)
