...
export default {
  ...
  methods: {
    showTaoDoiTuong() {
      this.modalShowQlDt = !this.modalShowQlDt
    }, showTaoLienKet() {
      this.modalShowQlLk = !this.modalShowQlLk
    },
    btnQLTuyen() {
      this.modalShowTTD = !this.modalShowTTD
      ...
      if (obj != null) {
        if (obj.type === "DOUBLE_CLICK") {
          ...
          if(this.obj1.id && this.obj1.id !==this.obj2.id && obj.typeObj ==="nodes"){
            ...
            console.log(parseInt(this.obj1.id) + " xx")
            console.log(parseInt(this.obj2.id) + " xx")
            console.log(parseInt(obj.id) + "xx")
            ...
            console.log( this.dsDoiTuongGianDo, "xx1")
            console.log(tenNguon, "xx1")
            console.log(tenDich, "xx1")
  ...
  // console.log("11122aa  " +obj.id + " "  +obj.offsetX +" "  +obj.offsetY  )
      if(obj.type === "OFFSET_CHANGE"){
        this.objChange = obj
          console.log("11122aa  "  +obj.offsetX +" "  +obj.offsetY  )
    ...
    getLoaiLienKet: async function () {
      ...
      console.log(this.dsLoaiDoiTuong[dataItem].TEN_LDT + "111")
    }
