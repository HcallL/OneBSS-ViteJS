...
import { cskhCommon } from "./commons"
...
import { phanquyennhanviennhankhaosat } from "./PhanQuyenNhanVienNhanKS"
...
import { thietlapthamso } from "./ThietLapThamSoLayPhieuKhaoSat"
...
export const cskh = {
  modules: {
    cskhCommon,
    tracuulichsuphananh,
    danhsachthuebaokhongkhaosat,
    giamthinhphieudakhaosat,
    danhsachphieukhaosatoutbound,
    mophieukhaosat,
    phanquyennhanviennhankhaosat,
    tracuukhachhanglon,
    quanlynhomintonghop,
    chuongtrinhCSKH,
    thietlapthamso,
    tiepnhanphananhkhachhang,
    danhsachkhachhanglon,
    thietlapdoituongkhaosat,
    taocongvieccskh,
    gannvchamsockhl,
    xacnhanphanhoinvkt,
    giaophieukhaosatkhachhang,
    duyetcongvieccskh,
    giaonvcskh,
    giaodvcskh,
    tracuuthuebaokhaosat,
    reg,
    thuchiencskh,
  }
}
