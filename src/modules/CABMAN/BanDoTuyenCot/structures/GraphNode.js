...
export default function GraphNode() {
  ...
  this.icons = {
    ...
    14: "CAP.jpg",
    15: "STRIPE.jpg",
    COT_CHUA_XD: "COT_CHUA_XD.jpg",
    COT_KHAC_TUYEN: "COT_KHAC_TUYEN.jpg",
    COT_SAT_T: "COT_SAT_T.jpg",
    COT_SAT_TRON: "COT_SAT_TRON.jpg",
    COT_TRON_LYTAM: "COT_TRON_LYTAM.jpg",
    COT_VUONG: "COT_VUONG.jpg"
  };
  this.setIcon = style => {
    if (style === 100) {
      const icondiemuon = {
    ...
    let iconname = null;
    console.log("🚀 ~ file: GraphNode.js:69 ~ GraphNode ~ style:", style);
    try {
