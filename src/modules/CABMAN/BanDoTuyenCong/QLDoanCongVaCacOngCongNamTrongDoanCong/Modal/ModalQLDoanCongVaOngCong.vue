...
export default {
  ...
  data: function () {
    return {
      ...
      showOngCong: false,
      titleTTOngCong: 'Click vào 1 ống cống phía trên để xem và cập nhật thông tin',
      idCong: null,
      idIconCong: null,
      picked: '1',
      waterMark: 'Chọn ngày',
  ...
  methods: {
    ...
    chiTietDoanCong: async function () {
      try {
        ...
        console.log('🚀 ~ file: ModalQLDoanCongVaOngCong.vue:364 ~ error:', error)
      } finally {
      }
    },
    ...
    getHuongBe: async function (beCapId, loai) {
      try {
        ...
        console.log('🚀 ~ file: ModalQLDoanCongVaOngCong.vue:388 ~ error:', error)
      } finally {
      }
    },
    ...
    initForm: async function () {
      try {
        ...
        if (rs.data != null) {
          ...
          console.log('🚀 ~ file: ModalQLDoanCongVaOngCong.vue:405 ~ this.dsDuAn:', this.dsDuAn)
        }
        ...
        console.log('🚀 ~ file: ModalQLDoanCongVaOngCong.vue:423 ~ error:', error)
      } finally {
      }
    },
    ...
    capNhat: async function () {
      try {
        ...
        if (rs.error_code == 'BSS-00000000') { this.$toast.success('Cập nhật đoạn cống thành công.') } else { this.$toast.error('Cập nhật đoạn cống thất bại.') }
      } catch (error) {
    ...
    themMoiOngCong: async function () {
      try {
        ...
        if (rs.error_code == 'BSS-00000000') { this.$toast.success('Thêm mới ống cống thành công.') } else { this.$toast.error('Thêm mới ống cống thất bại.') }
      } catch (error) {
    ...
    capNhatOngCong: async function () {
      try {
        ...
        if (rs.error_code == 'BSS-00000000') { this.$toast.success('Cập nhật ống cống thành công.') } else { this.$toast.error('Cập nhật ống cống thất bại.') }
      } catch (error) {
    ...
    xoaTatCaOngCong: async function () {
      try {
        ...
        } else { this.$toast.error('Xóa tất cả ống cống thất bại.') }
      } catch (error) {
    ...
    xoaOngCong: async function () {
      try {
        ...
        } else { this.$toast.error('Xóa ống cống thất bại.') }
      } catch (error) {
    ...
    tuDongSinhOngCong: async function () {
      try {
        ...
        } else { this.$toast.error('Tạo ống cống tự động thất bại') }
      } catch (error) {
