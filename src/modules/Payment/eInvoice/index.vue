  ...
  methods: {
    ...
    async hanldeDieuChinhHoaDon(){
      try{
        ...
        const checkThoaoiTra = await this.Thoai_Tra();
        if (!checkThoaoiTra)  return;
   ...
   async HuyHoaDon_VTT() {
    ...
    async Kiemtra_dulieu(_thaotac) {
      ...
      for (var i = 0; i < this.ds_kt.length; i++) {
        ...
        console.log(`this.kt_tongtien ${i} `, this.kt_tongtien )
      }
      ...
      if (this.Tag != 2 && this.Tag != 3) {
        ...
        if (this.Tag != 2 && this.Tag != 3) {
          ...
          if (this.ddlKieuDieuChinh == 3) {
            ...
            console.log("this.t_tien_edited:", this.t_tien_edited)
            if (this.t_tien_edited != 0) {
    ...
    setDataFromApiXuatHDDTLoad(js_returnds){
      ...
      if (js_returnds.DS_MESSAGE.length > 0) {
